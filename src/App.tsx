          ...
          {isValidUser && (
            <div>
              ...
              {showButtonMobile && (
                ...
                >
                  <a className="w-[65%]" href="https://eli-electric.app.dealmaker.tech/invitations/bb304fda-759d-4280-95e0-9cf79e2ef97e/view" target="_blank">
                    <Button className="relative w-full px-14 text-lg uppercase font-extrabold overflow-hidden">
