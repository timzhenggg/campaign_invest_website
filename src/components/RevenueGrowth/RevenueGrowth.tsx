...
const RevenueGrowth: React.FC = () => {
  ...
  return (
    <div
      ...
      className='xl:max-w-[300px] w-full h-full min-h-fit py-8 px-12 rounded-2xl sm:rounded-3xl md:rounded-2xl overflow-hidden flex flex-col items-center gap-4'
    >
