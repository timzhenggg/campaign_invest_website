...
const BarChart: React.FC = () => {
  ...
  return (
    <div ref={ref} className='relative w-full h-full'>
      ...
      <span className='absolute z-10 right-[12%] xxs:right-[12.5%] xs:right-[13.5%] sm:right-[15%] xl:right-[15%] top-[30%] sm:top-[42%] text-white font-bold text-xl xs:text-2xl sm:text-3xl md:text-4xl lg:text-5xl'>${counter1}B</span>
