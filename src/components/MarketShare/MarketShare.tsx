...
const MarketShare: React.FC = () => {
  ...
  return (
    <div 
      ref={ref}
      className="relative w-full h-full pt-12 pb-8 rounded-2xl flex flex-col justify-between items-center overflow-hidden"
    >
      {/* blurred Background */}
      <div
        style={{
      ...
      <div className="relative z-10 flex flex-1 flex-col items-center justify-between">
        <motion.h3
          className="text-primary-text text-3xl font-bold"
