...
const InvestIntro: React.FC<Props> = ({category}) => {
  ...
  return (
    <div 
      ...
      className='w-fit xl:w-full rounded-[40px] py-6 md:py-8 lg:py-12 px-4 sm:px-6 md:px-8 lg:px-12 xl:px-20 flex flex-col items-center gap-10'
    >
      <div className='w-full flex flex-col xl:flex-row items-center gap-4 sm:gap-6'>
        <Congrats category={category} />
        <span className='text-white font-bold text-5xl sm:text-7xl'>+</span>
        <InvestmentInfo />
      </div>

      <div className='w-full flex flex-col justify-center items-center'>
        <p className='text-xl md:text-2xl text-white text-center leading-[140%] font-bold'>
          + EARLY BIRD SPECIAL⏳:
        </p>
        <p className='text-xl md:text-2xl text-white text-center leading-[140%]'>Receive additional <span className='text-primary-green font-bold'>10 Bonus Shares</span></p>
