...
const SuccessfulProduction: React.FC = () => {
  ...
  return (
    <div
      ...
      className="w-full h-[550px] bg-no-repeat bg-contain rounded-2xl flex flex-col items-center justify-center gap-8"
    >
      <motion.h3
      ...
      >
        <p className="text-2xl text-white font-bold">
          <span className="font-bold text-8xl">4000/</span>year
        </p>
