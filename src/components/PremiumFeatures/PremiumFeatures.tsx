  ...
  return (
    <div className='p-8 h-full rounded-2xl bg-[#4A4A4A] flex gap-12'>
      ...
      <div className='flex flex-col justify-between gap-5'>
        <img src="/design-award.png" alt="design award" draggable={false} className='h-full' />
        <img src="/top-100-award.png" alt="top 100 award" draggable={false} className='h-full'/>
      </div>
    </div>
  );
};
