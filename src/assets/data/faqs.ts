export const faqs1 = [
  {
    title: "What’s your share price?",
    description: ["$9.80"],
  },
  {
    title: "What is the minimum investment size?",
    description: ["The minimum investment size for this current round is $793.80 plus a 2.5% transaction fee"],
  },
  {
    title: "What kind of shares are you issuing?",
  ...
  {
    title: "How will Eli Electric Vehicles make money?",
    description: [
  ...
  {
    title: "How do you plan to use the proceeds from this funding round?",
    description: [
  ...
  {
    title: "How do I get a return on my investment?",
    description: [
  ...
  {
    title: "How long are you expecting the company to operate before needing another round?",
    description: [
      "We expect proceeds from this round to allow us to continue to operate at least through the end of 2024. If we hit our revenue and operating goals, and reach cash flow positive, we will be able to continue to grow our business sustainably, however we may still need to raise additional capital to make additional investment and accelerate growth."
    ],
  },
  {
    title: "How many investors do you have already?",
    description: [
      "3,700+"
    ],
  },
  {
    title: "When will I receive my shares?",
    description: [
...
export const faq2 = [
  {
    title: "Where are your headquarters?",
    description: [
      "Established in 2015, Eli Electric Vehicles is headquartered in California and Beijing."
    ],
  },
  {
    title: "How many employees do you have?",
    description: [
      "25. In the past year, our team grew by over 20%, with pivotal roles filled in the US and a new Director of Supply Chain Operations, who joined our overseas team from China's largest micro-EV manufacturer."
    ],
  },
  {
    title: "When will Eli expand into additional markets and which ones?",
    description: [
      "We are working to expand in existing and new markets in Europe, making significant progress in preparation to launch in France and Germany. With a growing number of global distributor partners, we’re poised for rapid scaling and expansion. We are also preparing for Eli ZERO’s U.S. launch—the vehicle is expected to be available in the country in 2024, marking a pivotal milestone in our journey."
    ],
  },
  {
    title: "Can you share the roadmap for the next 3-4 years and when you expect to become profitable?",
    description: [
      "Eli is already successfully in production and sales across several countries in Europe. Our goal is to substantially increase sales and achieve economies of scale. Leveraging our capital efficiency, we anticipate generating cash flow from our initial EV within months. We'll channel investments toward developing new technologies and features and implementing cost-optimization measures to enhance our competitiveness. Beyond Eli ZERO, we have exciting plans to expand our existing vehicle platform into a range of new micro-EV products, services, and solutions. Our goal is to establish Eli as a top EV brand for Urban Mobility, tapping into a variety of applications and business models. By diversifying our product range, we aim to cater to a broader audience and address various aspects of urban transportation needs, possibly including commercial and utility applications."
    ],
  },
  {
    title: "Who are your competitors? What are your advantages against them?",
    description: [
